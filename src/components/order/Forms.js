...
{CasesIncidentFormConfig["numberofcomputersaffected"].type === "select" && (
                <TwoGridLayout>
                  <Field
                    as={SelectInput}
                    value={values.working}
                    setFieldValue={setFieldValue}
                    label={CasesIncidentFormConfig["numberofcomputersaffected"].label}
                    options={CasesIncidentFormConfig["numberofcomputersaffected"].options}
                    name="numberofcomputersaffected"
                    tooltip={<div style={{ color: colorCardinal }}>*</div>}
                    errors={touched["numberofcomputersaffected"] && errors["numberofcomputersaffected"]}
                  />
                </TwoGridLayout>
              )}
              {CasesIncidentFormConfig["destination"].type === "select" && (
              ...
              {CasesIncidentFormConfig["contact"].type === "text" && (
                <TwoGridLayout>
                  <Field
                    as={TextInput}
                    label={
                      CasesIncidentFormConfig?.["otheruser"]?.label
                    }
                    type="text"
                    onChange={(e) => {
